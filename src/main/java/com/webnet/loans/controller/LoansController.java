package com.webnet.loans.controller;
...
@Tag(
        name = "CRUD REST APIs for Loans in Webnet",
        description = "CRUD REST APIs in Webnet to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside Webnet"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    public ResponseEntity<LoansContactInfoDto> getContactInfo() {
        log.debug("---Loan contact api invoked-----");
        return ResponseEntity
                .status(HttpStatus.OK)
